...
TheWedgeWonState::TheWedgeWonState(firefly::Engine* engine):
	firefly::IGameState(engine, GameState::TheWedgeWon) {
}

TheWedgeWonState::~TheWedgeWonState() {
}

void TheWedgeWonState::onEnter() {
	if (!isInit()) {
		return;
	}
...
void TheWedgeWonState::buildObjects() {
	const auto engine = getEngine();
