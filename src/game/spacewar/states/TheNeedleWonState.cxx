...
TheNeedleWonState::TheNeedleWonState(firefly::Engine* engine):
	firefly::IGameState(engine, GameState::TheNeedleWon) {
}

TheNeedleWonState::~TheNeedleWonState() {
}

void TheNeedleWonState::onEnter() {
	if (!isInit()) {
		return;
	}
...
bool TheNeedleWonState::onEvent(
...
void TheNeedleWonState::buildObjects() {
	const auto engine = getEngine();
